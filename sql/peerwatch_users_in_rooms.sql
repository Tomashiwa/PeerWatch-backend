...
CREATE TABLE `users_in_rooms` (
  ...
  KEY `fk_users_in_rooms_rooms` (`roomid`),
  CONSTRAINT `fk_users_in_rooms_rooms` FOREIGN KEY (`roomid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_users_in_rooms_users` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-10-16  4:44:13
